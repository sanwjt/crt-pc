...
//					_this.cancelTouchmove();
    ...
    var inlineCss = '*{margin:0;padding:0;box-sizing:border-box}.verify-wrap{width:350px;height:60px;background-color:#f7f7f7;border:1px solid #e0e0e0;margin:5px auto;position:relative}.verify-wrap .drag-btn{position:absolute;left:-1px;top:-1px;width:60px;height:60px;background:#fff url(data:image/png;base64,) no-repeat center center;background-size:100% 100%;z-index:2;cursor:move;}.verify-wrap .suc-drag-btn{background:#fff url(../img/yanzheng-correct.png) no-repeat center center;border: 1px solid #e0e0e0}.verify-wrap .drag-progress{position:absolute;left:0;top:-1px;height:60px;border-top:1px solid #f7f7f7;border-top:1px solid #ccc;width:0;background-color:#f7f7f7;color:#fff;font-size:18px;text-align:center;line-height:60px}.verify-wrap .fix-tips,.verify-msg{width:100%;position:absolute;right:0;left:1px;height:100%;color:#FF8721;z-index:1;line-height:60px;font-size:16px;text-align:center}.verify-wrap .verify-msg{background-color:#f7f7f7;color:#79D9E4;display:none;border-bottom:1px solid #e0e0e0}';
	var styleObj = $(
